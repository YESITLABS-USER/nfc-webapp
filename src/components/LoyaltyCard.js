      ...
      onClick={() => {
        ...
        <div className="get-free-coupon-content">
          <div className="inner-wrap-free-coupon">
            ...
            <h2>{lang == "eng" ? "GET FREE" : "SAAT ILMAISEKSI"} <br /> { modifiedFreeItem?.length > 15 ? modifiedFreeItem?.substring(0, 12) + "..." : modifiedFreeItem}</h2>
            <span>{lang == "eng" ? "Collect" : "Kerää"} {total_stamps} {lang == "eng" ? "stamps and get" :"leimaa ja saat"} {free_item}.</span>
          </div>
        </div>
