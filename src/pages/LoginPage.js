...
const LoginPage = () => {
  ...
  const validationSchema = Yup.object({
    ...
    // .matches(/^(\+1\d{10}|\+358\d{10})$/,'Phone number must be a valid US number starting with +1 (followed by 10 digits) or a Finnish number starting with +358 (followed by 10 digits)')
    });
