          ...
          >
            ...
            <div className={`coupon-right ${colorMapping.includes(currentCoupanData?.color_selection) || colorMapping["orange"]} ${currentCoupanData?.color_selection}-bg`}>
              <div className="coupon-right-text">
                ...
                <p>{lang =="eng" ?  "VALID UNTIL " : "Voimassa asti "} : <b> {currentCoupanData?.validity_no_limit ? "voimassa toistaiseksi" : currentCoupanData?.validity_expiration_date ? formatDate(currentCoupanData?.validity_expiration_date) : "voimassa toistaiseksi"} </b></p>
                {/* <span>Age : 18+</span> */}
              </div>
            </div>
          </div>
